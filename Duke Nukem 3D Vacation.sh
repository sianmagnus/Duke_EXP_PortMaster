...
GAMEDIR="/$directory/ports/rednukem-dn3d-vacation"
...
$GPTOKEYB "rednukem" &
LD_LIBRARY_PATH="$GAMEDIR/lib:$LD_LIBRARY_PATH" SDL_GAMECONTROLLERCONFIG="$sdl_controllerconfig" ./rednukem -game_dir $GAMEDIR/gamedata 2>&1 | tee $GAMEDIR/log.txt
